...
//IMPORTANT:
//********************************************************************************************//
// Try try and replace the SqlEndPoint reference with a parameter as well as the database reference in each partition.
// Run the script and enter a Parameter Name and the value used in the M partitions and the script will update the partitions for you with the new parameter reference
//********************************************************************************************//
